...
const LogoMarquee = () => {
  ...
  return (
    <section className="py-32 overflow-hidden bg-[#020209] relative border-y border-white/5">
      ...
      <div className="container mx-auto px-4 mb-24 text-center relative z-10">
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <span className="px-6 py-2 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs md:text-sm font-bold uppercase tracking-[0.3em] mb-8 inline-block shadow-[0_0_20px_rgba(99,102,241,0.2)]">
            {t('happyClients')}
          </span>
      ...
      <div className="absolute inset-y-0 left-0 w-32 md:w-96 bg-gradient-to-r from-[#020209] via-[#020209]/80 to-transparent z-20 pointer-events-none" />
      <div className="absolute inset-y-0 right-0 w-32 md:w-96 bg-gradient-to-l from-[#020209] via-[#020209]/80 to-transparent z-20 pointer-events-none" />
    </section>
  );
};
